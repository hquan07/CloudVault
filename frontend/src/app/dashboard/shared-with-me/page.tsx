...
import { FolderOpen, File as FileIcon, Users } from 'lucide-react';
      ...
      {folders.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {folders.map(folder => (
            <div 
              key={folder.id} 
              className="group bg-gray-900 border border-gray-700 rounded-2xl p-5 hover:border-cyan-500/50 transition-all hover:shadow-lg hover:shadow-cyan-900/10 flex items-center gap-4"
            >
